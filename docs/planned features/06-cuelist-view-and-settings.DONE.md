...
This document contains implementation guidance for the Cuelist View and its persisted settings. Behavioral acceptance scenarios live in [`docs/testing/02-cues-tracking-and-arbitration.md`](../testing/02-cues-tracking-and-arbitration.md), especially CUE-011 and CUE-012. Implement the capabilities here before adding or enabling their Playwright coverage.
