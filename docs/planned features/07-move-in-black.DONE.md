...
This document defines the implementation required by [MIB-001 in the Cue and playback test scenarios](../testing/02-cues-tracking-and-arbitration.md). Implement the patch schema, playback look-ahead, and UI controls here before enabling the matching Playwright test.
