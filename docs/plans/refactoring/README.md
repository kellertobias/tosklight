...
| 28 | [Desk-wide Highlight look](doing/28-desk-wide-highlight-look.md) | In progress: build desk-owned semantic Highlight configuration on the completed Highlight application service. |
