...
**Specification only.** This plan records a future Desk Setup and optional-screen display mode. It does not implement screen configuration, native windows, pane rendering, persistence, help changes, screenshots, or executable tests.
