...
- The executable contracts are [`MANUAL-019`](../../../tests/19-manual-review-software-corrections.spec.ts), [`FILE-001`, `FILE-002`, and `TEXT-001`](../../../tests/08-file-manager-and-text-editor.spec.ts), [`FILE-016`](../../../tests/16-file-manager.spec.ts), and [`TEXT-015`](../../../tests/15-text-editor.spec.ts), plus focused UI unit coverage for legacy pane hydration, picker accessibility, output routes, and recovery.
