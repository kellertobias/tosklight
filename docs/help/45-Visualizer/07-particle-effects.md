...
visible-spark-lifetime controls. **Generic Flame Jet** demonstrates a single-nozzle effect, while
**Generic Five-nozzle Flame Unit** demonstrates one package-owned program producing five
independently positioned and angled nozzles. Both flame fixtures are ToskLight reference profiles,
not manufacturer hardware personalities. A manufacturer profile should
