...
| VPB-007 | Virtual Playbacks | inert Shift selection and named zone editing; show-level snapshots with isolated desk/surface partitions; overlap union; concurrent UI/REST/OSC/keyboard activation; hidden membership; restart and desk isolation | persisted zone store, serialized playback runtime, UI Settings, audit, rendered output |
