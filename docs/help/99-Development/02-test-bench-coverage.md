...
| VPB-007 | Virtual Playbacks | inert software/hardware Shift selection and named zone editing; show-level snapshots with isolated desk/surface partitions; overlap union; concurrent UI/REST/OSC activation; hidden membership; restart and desk isolation | persisted zone store, serialized playback runtime, UI Settings, audit, rendered output |
