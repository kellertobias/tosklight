...
| 2D/3D Stage, position setup, scenery/models | [Stage Positions and Scenery](../20-Show-Setup/04-stage-positions-and-scenery.md) | `stage-window-2d.png`, `stage-settings.png`; 3D scenery requires desktop QA |
