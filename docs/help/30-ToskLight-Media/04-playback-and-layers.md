...
- **Playback** — Play mode, Dimmer, Volume, Speed, Playback BPM, and Blur, followed by the **Playback range** heading with **In point** and **Out point**, shown and typed as `mm:ss.ff` at the frame rate in **Settings > Libraries > In and Out points** (see [Playback range](05-generated-sources-and-effects.md#playback-range)). The range is shown on this tab only.
