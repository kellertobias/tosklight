...
| `crates/light/domain/playback` | Cue models, tracking, Dynamic values, active Playback runtime, automatic transitions, and arbitration | `crates/light/domain/playback/src/lib.rs`, `crates/light/domain/playback/src/model/`, `crates/light/domain/playback/src/automatic.rs` |
