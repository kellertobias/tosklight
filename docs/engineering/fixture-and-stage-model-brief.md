...
No models. A stage deck is generated by the renderer at the size and height it is placed, on a
scissor lift or on four regular feet, so the standard deck sizes **1000 × 500**, **1000 × 1000**
and **2000 × 1000** are three profiles rather than one model per leg height. The fifteen modelled
decks that covered 200 to 1000 mm legs are retired.
