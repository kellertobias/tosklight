...
Open **Timecode Settings** and confirm it owns name, duration and frames, transport offset, auto-start, audio file, and marker CSV. Each change saves immediately with revision-safe ordering and there is no Save button. Confirm **Play**, **Pause**, **Rewind to start**, and **Stop** are grouped in the title. The title **Add** menu contains exactly **Add Marker**, **Add Audio Lane**, **Add Speed Lane**, and **Add Cuelist Lane**; it does not contain Add Playhead.
