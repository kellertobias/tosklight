...
- the Fixture Sheet covers subdued remembered-base rows, a prominent current step, multi-head rows, collapsed-parent contained state, HIGH-independent presentation, ALL restoration, and external-selection reset;
