...
- `tosklight-app-icon.png` is the high-resolution transparent application tile for presentations and documentation.
...
The platform-specific macOS, Windows, and PNG application assets are generated from `apps/control-ui/src-tauri/icons/icon.svg` with the Tauri icon generator.
