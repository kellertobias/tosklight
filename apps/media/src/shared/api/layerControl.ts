		...
		output.id === outputId
			? {
					...
					master: {
						...
						maskPositionX: change.maskPositionX ?? output.master.maskPositionX,
						maskPositionY: change.maskPositionY ?? output.master.maskPositionY,
...
function withChange(
	...
	return {
		...
		mask: {
			...
			positionX: change.maskPositionX ?? layer.mask.positionX,
			positionY: change.maskPositionY ?? layer.mask.positionY,
