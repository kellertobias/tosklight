...
export type RunningServerView = {
	administrationIp: string;
	outputs: Array<RunningOutputView>;
};
...
export type EffectParameterView = {
	id: string;
	label: string;
	value: number;
	defaultValue: number;
};
export type EffectSlotView = {
	index: number;
	...
	parameters: Array<EffectParameterView>;
...
export type MasterView = {
	...
	shaperTop: number;
	shaperBottom: number;
	shaperLeftRotation: number;
	shaperRightRotation: number;
	shaperTopRotation: number;
	shaperBottomRotation: number;
	shaperRotation: number;
};
...
export type AvailableMonitorView = {
	index: number;
	name: string;
	width: number;
	height: number;
...
export type OutputConfigurationView = {
	 ...
	 */
	availableMonitors: Array<AvailableMonitorView>;
	/**
	 ...
	 */
	active: OutputConfigurationValuesView;
...
export type FolderPresentationView = {
	folder: number;
	name: string | null;
	icon: string | null;
	pictureUrl: string | null;
};
export type FolderPresentationsView = {
	folders: Array<FolderPresentationView>;
};
...
export type NetworkView = {
	 ...
	 */
	activeSameComputerPreset: boolean;
	activeStored: NetworkAddressesView;
	/**
...
export type TextFormatView = {
	clockPattern: string;
	countdownPattern: string;
	separator: string;
...
export type UpdateLayer = {
	...
	effectMix?: number | null;
	tvCurvature?: number | null;
	effectDistortion?: number | null;
	imageGrain?: number | null;
	compressionDamage?: number | null;
	blockSize?: number | null;
	tileDisplacement?: number | null;
	chromaDamage?: number | null;
	effectGlitching?: number | null;
	/**
	 * `every-beat`, `every-half-beat`, or `every-second` for the opacity cycle effect.
	 */
	cycleInterval?: string | null;
	blurAmount?: number | null;
	feedbackAmount?: number | null;
	feedbackMotion?: number | null;
	feedbackDirection?: string | null;
	beatMoveAmount?: number | null;
	beatMoveDirection?: string | null;
	beatMoveDecay?: number | null;
	kaleidoscopeRepetitions?: number | null;
	kaleidoscopeAngle?: number | null;
	rasterizeMode?: string | null;
	rasterizeDotSize?: number | null;
	beatScanWidth?: number | null;
	beatScanEdge?: string | null;
	beatScanFalloff?: number | null;
	beatScanDuration?: number | null;
	beatScaleAmount?: number | null;
	beatTurnEnabled?: boolean | null;
	beatTurnRotation?: number | null;
	beatScaleDecay?: number | null;
	beatGridDensity?: number | null;
	beatGridHeight?: number | null;
	beatGridDuration?: number | null;
	beatGridOrigin?: string | null;
	beatGridHue?: number | null;
	beatGridBrightness?: number | null;
	beatFormEnlargement?: number | null;
	beatFormLifetime?: number | null;
	beatFormDensity?: number | null;
	beatFormVariation?: number | null;
	drawnStrength?: number | null;
	drawnLineDetail?: number | null;
	/**
...
export type UpdateMaster = {
	...
	positionY?: number | null;
	rotation?: number | null;
	shaperLeft?: number | null;
	shaperRight?: number | null;
	shaperTop?: number | null;
	shaperBottom?: number | null;
	shaperLeftRotation?: number | null;
	shaperRightRotation?: number | null;
	shaperTopRotation?: number | null;
	shaperBottomRotation?: number | null;
	shaperRotation?: number | null;
};
...
export type UpdateFolderPresentation = {
	requestId: string;
	name?: string | null;
	icon?: string | null;
};
