...
export type MaskView = { address: AddressView, scaleX: number, scaleY: number, positionX: number, positionY: number, invert: boolean, opacity: number,
/**
 * `alpha` or `luminance`.
 */
source: string,
 ...
 */
requestId: string, folder: number, file: number,
/**
 ...
 */
style?: TextStyleView | null, format?: TextFormatView | null, };
