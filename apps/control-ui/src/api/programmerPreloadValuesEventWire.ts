import type { ProgrammerPreloadValuesEventMessage } from "../features/programmerPreloadValues/contracts";
import {
	arrayAt,
	enumAt,
	exactRecordAt,
...
function decodeChange(value: unknown) {
	...
	enumAt(payload.type, "$.event.payload.type", [
		"programming_preload_values_changed",
	]);
...
function optionalUuid(
	...
	return object[key] == null
		? null
		: programmerPreloadValuesUuidAt(object[key], `${path}.${key}`);
}
