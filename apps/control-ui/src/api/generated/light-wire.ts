...
export type ProgrammingValueMutation = { "type": "set_selection", fixture_ids: Array<string>, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "set_fixture", fixture_id: string, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "release_fixture", fixture_id: string, attribute: string, } | { "type": "set_group", group_id: string, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "release_group", group_id: string, attribute: string, };

export type ProgrammingValuesAction = { "type": "set_selection", fixture_ids: Array<string>, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "set_fixture", fixture_id: string, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "release_fixture", fixture_id: string, attribute: string, } | { "type": "set_group", group_id: string, attribute: string, value: ProgrammingAttributeValue, timing: ProgrammingValueTiming, } | { "type": "release_group", group_id: string, attribute: string, } | { "type": "batch", mutations: Array<ProgrammingValueMutation>, } | { "type": "clear" };
