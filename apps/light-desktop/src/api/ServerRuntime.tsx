...
function useProviderDataSources(
	...
	const mediaServersState = useMemo(
		() => ({
			...
			clearMediaThumbnailCache: value.clearMediaThumbnailCache,
			...
			updateNativeMediaEffect: value.updateNativeMediaEffect,
		...
		[
			...
			value.clearMediaThumbnailCache,
			value.inspectMediaServer,
			value.nativeMedia,
			value.updateNativeMediaText,
			value.updateNativeMediaEffect,
