...
export type NativeMediaSnapshot = { endpoint: string, status: string, instance: string, outputs: number, catalog_revision: number, catalog_items: number, text_slots: Array<NativeMediaTextSlot>, effect_controls_available: boolean, };
