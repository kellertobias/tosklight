...
export type ConfigurationPatch = { frame_rate_hz?: number | null, output_bind_ip?: string | null, osc_bind?: string | null | null, art_timecode_bind?: string | null | null, timecode_sources?: Array<TimecodeSourceConfiguration> | null, osc_timecode?: OscTimecodeConfiguration | null | null, backup_retention?: number | null, autosave_interval_seconds?: number, programmer_fade_millis?: number, command_line_at_uses_programmer_fade?: boolean | null, sequence_master_fade_millis?: number, cuelist_auto_off_at_zero_default?: boolean | null, cuelist_auto_off_flash_release_default?: boolean | null, start_after_first_recording?: boolean | null, preload_programmer_changes?: boolean | null, preload_physical_playback_actions?: boolean | null, preload_virtual_playback_actions?: boolean | null, patch_preview_highlight_dmx?: boolean | null, highlight_look?: HighlightLookConfiguration | null, matter_enabled?: boolean | null, pool_presentation?: PoolPresentationConfiguration | null, file_manager_system_picker_fallback?: boolean | null, file_manager_roots?: Array<FileManagerRoot> | null, };
...
export type PlaybackTopologyTarget = { "type": "cue_list", cue_list_id: string, } | { "type": "dynamic", assignment: PlaybackTopologyDynamicAssignment, } | { "type": "macro", macro_id: string, } | { "type": "group", group_id: string, initial_master?: number | null, } | { "type": "speed_group", group: string, } | { "type": "programmer_fade", } | { "type": "cue_fade", } | { "type": "grand_master", };
...
export type MacroToken = { start: number, end: number, kind: MacroTokenKind, };
export type MacroTokenKind = "keyword" | "target" | "operator" | "address" | "number" | "timing" | "comment" | "text";
export type MacroLineDiagnostic = { line: number, status: MacroLineStatus, message: string, tokens: Array<MacroToken>, };
export type MacroValidationRequest = { source: string, };
export type MacroValidation = { valid: boolean, diagnostics: Array<MacroLineDiagnostic>, };
export type MacroObjectActionRequest = { request_id: string, action: MacroObjectAction, };
export type MacroObjectAction = { "type": "create", definition: MacroDefinition, } | { "type": "update", macro_id: string, expected_revision: number, patch: MacroPatch, } | { "type": "delete", macro_id: string, expected_revision: number, };
...
export type TimecodePatch = { number?: number | null, name?: string | null, duration_frame?: number | null, transport_offset_frame?: number | null, auto_start?: boolean | null, markers?: Array<TimecodeMarker> | null, lanes?: Array<TimecodeLane> | null, };
...
export type TimecodeTransportSnapshot = { timecode_id: string, state: TimecodeTransportState, frame: number, duration_frame: number, audio_linked: boolean, };
