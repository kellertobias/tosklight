...
export type CommandGestureKind = "regular" | "double" | "hold";
export type CommandGesture = { kind: CommandGestureKind, shifted: boolean, };
...
export type CommandKeyRequest = { key: CommandKey, phase: CommandKeyPhase, gesture?: CommandGesture | null, request_id: string, };
...
export type CommandLineChangedEvent = { desk_id: string, session_id: string, text: string, target: CommandTarget, pristine: boolean, revision: number, source: CommandHttpSource, request_id?: string | null, redacted?: boolean, };
...
export type ExtensionInstanceSnapshot = { id: string, extension_id: string, package_digest: string, executable: string, capabilities: Array<string>, state: string, last_error: string | null, launches: bigint, crashes: bigint, protocol_errors: bigint, inbound_drops: bigint, outbound_drops: bigint, };
...
export type FileInputAction = "rename" | "copy" | "move" | "delete" | "macro_edit";
export type FileInputOrigin = "pending" | "toolbar" | "editor";
...
export type ProgrammerPriorityProjection = { revision: number, priority: number, changed_at: string, };
export type ProgrammerPriorityChange = { "type": "upsert", projection: ProgrammerPriorityProjection, } | { "type": "remove", revision: number, };
...
export type CueRecordTarget = { "kind": "pool", playback_number: number, } | { "kind": "selected_playback" } | { "kind": "page_slot", page: number, slot: number, } | { "kind": "cue_list", cue_list_id: string, } | { "kind": "virtual", page: number, playback_number: number, };
export type CueRecordOperation = "overwrite" | "merge" | "subtract" | "add_missing" | "add_cue";
...
export type CueRecordRequest = { request_id: string, target: CueRecordTarget, operation: CueRecordOperation, cue_number?: string | null, timing: CueRecordTiming, cue_only: boolean, name?: string | null, capture_policy: CueRecordCapturePolicy, activation_policy: CueRecordActivationPolicy, };
...
export type RecordedCueProjection = { id: string, number: string, deleted: boolean, };
...
export type CueDeletionRequest = { request_id: string, address: CueDeletionAddress, cue_number: string, authority: CueDeletionAuthority, };
export type CueDeletionObjectProjection = { cue_list_id: string, object_id: string, object_revision: number, body: unknown, };
export type DeletedCueProjection = { id: string, number: string, };
...
export type CueTransferSummary = { operation: CueTransferOperation, mode: CueTransferMode, source_cue_id: string, source_cue_number: string, destination_cue_id: string, destination_cue_number: string, };
...
export type ProgrammingUpdateTarget = { "type": "cue", cue_list_id: string, playback_number?: number | null, cue_id?: string | null, cue_number?: string | null, validate_active_context: boolean, } | { "type": "preset", object_id: string, } | { "type": "group", object_id: string, };
export type ProgrammingUpdateTargetFamily = { "type": "cue" } | { "type": "preset" } | { "type": "group" };
export type ProgrammingUpdateCueIdentity = { id: string, number: string, };
...
export type ProgrammingRecordUpdateOption = "smart" | "merge" | "add_existing" | "add_cue";
export type ProgrammingUpdateSettings = { cue_mode: ProgrammingUpdateCueMode, preset_mode: ProgrammingUpdateExistingContentMode, group_mode: ProgrammingUpdateExistingContentMode, show_update_modal_on_touch: boolean, record_default: ProgrammingRecordUpdateOption, update_default: ProgrammingRecordUpdateOption, };
export type ProgrammingUpdateSettingsProjection = { settings: ProgrammingUpdateSettings, };
export type ProgrammingUpdateSettingsUpdateRequest = { request_id: string, settings: ProgrammingUpdateSettings, };
export type ProgrammingUpdateSettingsUpdateOutcome = { request_id: string, replayed: boolean, settings: ProgrammingUpdateSettings, };
...
export type VisualizerConnectionNotification = { connected: boolean, };
...
export type MediaNotificationKind = "thumbnails_refreshed" | "preview_refreshed" | "server_offline" | "server_online" | "thumbnail_cache_cleared";
export type MediaNotification = { revision: number, kind: MediaNotificationKind, };
export type DeskActionNotification = { action: string | null, control: string | null, value: string | null, request_id?: string | null, session_id: string | null, desk_id: string | null, path: string | null, };
...
export type PlaybackConfigurationNotification = { desk_id: string, addressing: string, page: number | null, slot: number | null, playback: number | null, };
...
export type PreloadRecordAction = { "type": "preset", target_id: string, expected_revision: number, name: string, mode: PreloadPresetMode, family: PreloadPresetFamily, } | { "type": "cue", cue_list_id: string, expected_revision: number, cue_number: string, name: string | null, };
...
export type FixtureFreezeOperation = "freeze" | "unfreeze" | "toggle";
export type FixtureFreezeLiveActionRequest = { operation: FixtureFreezeOperation, families: Array<FixtureFreezeFamily>, };
export type FixtureFreezeActionOutcome = { changed: boolean, patch_revision: number, affected_fixtures: number, };
