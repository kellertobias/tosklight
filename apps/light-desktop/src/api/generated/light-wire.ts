...
export type AttributePlacement = { attribute: string, encoder_group: AttributeEncoderGroup, encoder_page: number, encoder_slot: number, };
...
export type ConfiguredAttributeDescriptor = { id: string, label: string, encoder_group: AttributeEncoderGroup, encoder_page: number, encoder_slot: number, value_type: AttributeValueType, display_unit: string | null, physical_unit: string | null, normalized_min: number | null, normalized_max: number | null, domain_min: number | null, domain_max: number | null, cyclic: boolean, recordable: boolean, built_in: boolean, retired: boolean, activation_group_id: string | null, };
...
export type FixtureLibraryAction = { "type": "save_profile", profile: unknown, expected_revision: number, } | { "type": "delete_profile_revision", profile_id: string, revision: number, } | { "type": "import_package", package_base64: string, attribute_mappings: Array<FixtureAttributeMapping>, } | { "type": "attach_gdtf", profile_id: string, revision: number, source_base64: string, } | { "type": "save_definition", definition: unknown, } | { "type": "delete_definition_revision", definition_id: string, revision: number, };
...
export type RuntimeAttributeDescriptor = { id: string, label: string, family: string, value_type: string, default_unit: string | null, display_unit: string | null, physical_unit: string | null, normalized_min: number | null, normalized_max: number | null, domain_min: number | null, domain_max: number | null, cyclic: boolean, recordable: boolean, encoder_group: AttributeEncoderGroup, encoder_page: number, encoder_slot: number, built_in: boolean, retired: boolean, activation_group_id: string | null, };
...
export type ScreenContent = { "type": "desktop" } | { "type": "control_surface" } | { "type": "none" } | { "type": "fixed_pane", pane: FixedScreenPane, } | { "type": "fixed_side_pane", pane: FixedScreenPane, side: FixedScreenSide, width_px: number, };
