...
export type FixedScreenFixtureColumn = "id" | "icon" | "name" | "patch" | "dimmer" | "color" | "position" | "beam" | "focus";
export type FixedScreenStageRenderQuality = "lines_only" | "lines_and_beams" | "full";
export type FixedScreenTextMode = "plain" | "markdown";
export type FixedScreenPane = { "type": "fixture_sheet", included_heads: FixedScreenFixtureIncludedHeads, order: FixedScreenFixtureOrder, active_only: boolean, cue_list_id: string | null, columns: Array<FixedScreenFixtureColumn>, show_type: boolean, show_group_shortcuts: boolean, } | { "type": "stage_2d", follow_preload: boolean, show_floor_grid: boolean, } | { "type": "stage_3d", follow_preload: boolean, show_floor_grid: boolean, show_beam_guides: boolean, render_quality: FixedScreenStageRenderQuality, environment_brightness: number, } | { "type": "cues", cue_list_id: string, } | { "type": "text", root: string, path: string, mode: FixedScreenTextMode, };
