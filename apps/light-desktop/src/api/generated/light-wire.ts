...
export type ProgrammingPreloadValuesAction = { "type": "apply_intent", fixture_ids: Array<string>, group_id?: string | null, attribute: string, operation: ProgrammingPreloadValueOperation, undo_group?: string | null, timing: ProgrammingPreloadValueTiming, } | { "type": "set_fixture", fixture_id: string, attribute: string, value: ProgrammingPreloadAttributeValue, timing: ProgrammingPreloadValueTiming, } | { "type": "release_fixture", fixture_id: string, attribute: string, } | { "type": "set_group", group_id: string, attribute: string, value: ProgrammingPreloadAttributeValue, timing: ProgrammingPreloadValueTiming, } | { "type": "release_group", group_id: string, attribute: string, } | { "type": "batch", mutations: Array<ProgrammingPreloadValueMutation>, };
