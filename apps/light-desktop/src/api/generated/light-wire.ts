...
export type ShowObjectKind = "attribute_configuration" | "cue_list" | "dynamic" | "group" | "patch_layer" | "playback" | "playback_page" | "preset" | "schedule" | "stage_layout" | "user_layout";
...
export type PlaybackTopologyTarget = { "type": "cue_list", cue_list_id: string, } | { "type": "dynamic", assignment: PlaybackTopologyDynamicAssignment, } | { "type": "group", group_id: string, initial_master?: number | null, } | { "type": "speed_group", group: string, } | { "type": "programmer_fade", } | { "type": "cue_fade", } | { "type": "grand_master", };
