...
export type AttributeConfigurationSnapshot = { show_id: string | null, show_revision: number, object_revision: number, configuration: AttributeConfiguration, descriptors: Array<ConfiguredAttributeDescriptor>, validation_error: string | null, };
