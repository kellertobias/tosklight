...
/**
 * The options after one choice, or why it is refused. An empty colour returns the object to its
 * kind's own material, which is what it was drawn in before anyone chose.
 */
