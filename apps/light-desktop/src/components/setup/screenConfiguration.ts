...
export const DEFAULT_FIXED_SCREEN_PANE: FixedScreenPane = {
	type: "fixture_sheet",
	included_heads: "all",
	order: "fixture_id",
	active_only: false,
...
export function defaultDeskPlaybackLayout(
	desk: ControlDesk,
): PlaybackSurfaceLayout {
	return (
		desk.playback_layout ?? {
...
export function screenPlaybackLayout(
	screen: ScreenConfiguration,
): PlaybackSurfaceLayout {
