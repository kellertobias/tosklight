...
export const windowChoices: Array<[BuiltInWindow, string]> = [["presets", "Preset pool"], ["groups", "Group pool"], ["fixtures", "Fixture sheet"], ["stage", "Stage"], ["layout", "Layout"], ["cuelist_pool", "Cuelist Pool"], ["cues", "Cues · Cuelist"], ["cuelists", "Cuelists (tabs)"], ["virtual_playbacks", "Virtual Playbacks"], ["file_manager", "File Manager"], ["text_editor", "Text Editor"], ["channels", "Channels"], ["dynamics", "Dynamics"], ["scheduler", "Scheduler"], ["dmx", "DMX output"], ["help", "Help"]];
