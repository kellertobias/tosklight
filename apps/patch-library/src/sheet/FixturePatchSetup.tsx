...
/** The shared fixture-library and placement workflow without the surrounding Patch table. */
...
/** Opens the normal fixture-address modal for a fixture linked from another workspace. */
