  ...
  function LargeTextInput({
    ...
    return <span className="ui-large-text-control">
      ...
      <Button size="compact" iconOnly className="ui-large-text-up"
        aria-label="Scroll text up" disabled={disabled}
      ...
      <Button size="compact" iconOnly className="ui-large-text-down"
        aria-label="Scroll text down" disabled={disabled}
        onClick={() => native.current && scrollTextArea(native.current, 1)}>
      ...
      {open && <InputModal kind="multiline" value={current} placeholder={props.placeholder}
