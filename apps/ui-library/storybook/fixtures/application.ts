...
export const stagePresentations: StageFixturePresentation[] = [
  { fixtureId: "front-left", fixtureNumber: 1, name: "Front Fresnel Left", icon: null, color: "#ffd9a8", dimmer: 78, pan: 0.38, tilt: 0.66 },
  { fixtureId: "front-right", fixtureNumber: 2, name: "Front Fresnel Right", icon: null, color: "#ffd9a8", dimmer: 62, pan: 0.62, tilt: 0.66 },
  { fixtureId: "wash-left", fixtureNumber: 201, name: "LED Wash Left", icon: null, color: "#3b8cff", dimmer: 86, pan: 0.44, tilt: 0.48 },
  { fixtureId: "wash-right", fixtureNumber: 202, name: "LED Wash Right", icon: null, color: "#c65cff", dimmer: 72, pan: 0.56, tilt: 0.48 },
  { fixtureId: "profile", fixtureNumber: 101, name: "Center Profile", icon: null, color: "#ffffff", dimmer: 92, pan: 0.5, tilt: 0.34 },
];
...
export const stage3dFixtures: Stage3dFixture[] = fixtures.map((fixture, index) => ({
  fixture,
  index,
  position: {
    x: (index - 2) * 1.8,
...
export const stageVisualization: VisualizationSnapshot = {
  ...
  values: fixtures.flatMap((fixture, index) => [
    { fixture_id: fixture.fixture_id, attribute: "intensity", value: { kind: "normalized" as const, value: [0.78, 0.62, 0.86, 0.72, 0.92][index] } },
    { fixture_id: fixture.fixture_id, attribute: "pan", value: { kind: "normalized" as const, value: 0.42 + index * 0.04 } },
    { fixture_id: fixture.fixture_id, attribute: "tilt", value: { kind: "normalized" as const, value: 0.48 } },
  ]),
};
