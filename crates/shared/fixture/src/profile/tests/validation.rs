...
fn schema_v2_named_aliases_are_limited_to_documented_unambiguous_mappings() {
    for (legacy, canonical) in [
        ...
        ("gobo.gobo_wheel", "gobo.1"),
        ("gobo.rotating_gobo_selection", "gobo.1"),
        ("gobo.rotating_gobo_wheel", "gobo.1"),
        ("gobo.gobo_index_rotation", "gobo.1.rotation"),
        ("gobo.rotating_gobo_index_rotation", "gobo.1.rotation"),
        ("gobo.fixed_gobo_wheel", "gobo.2"),
        ("prism.prism", "prism.1"),
