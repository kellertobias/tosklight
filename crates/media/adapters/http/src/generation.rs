...
use crate::wire::{
    ...
    ClearedModelSlotView, CreateText, CreateVisualizer, DataFolderChangeView, DataFolderEntryView,
    DataFolderListingView, DeleteLibraryItem, DeleteLibraryItems, DeleteText, DeskIdentityView,
    DisplayRegionView, DmxChannelGroupView, DmxChannelView, DmxIngressView, DmxMapView,
    DmxPersonalityView, DmxResolutionView, DmxValueSetView, EffectBankView, EffectParameterView,
    EffectPresetView, EffectSlotView, FolderPresentationView, FolderPresentationsView, Health,
    ImportJobView, ImportsView, LayerView, LibraryNoteTargetView, LibrarySettingsView,
    LogRecordView, LogsView, MaskView, MasterView, ModelSlotView, NetworkAddressesView,
    NetworkView, OutputConfigurationValuesView, OutputConfigurationView, OutputView,
    PendingImportView, PixelLayoutView, PixelMapView, PixelRouteView, PixelZoneHandoffView,
    PixelZoneView, PlaybackView, RemoveFolderPicture, RunningOutputView, RunningServerView,
    ServerLogLevelView, SourceStatusView, SpeedGroupReadingView, SpeedGroupReceptionView,
    SpeedGroupRejectionView, StartImport, TelemetryFrame, TextFormatView, TextSlotView,
    TextStyleView, TimeView, UpdateAudio, UpdateDataFolder, UpdateEffectPreset,
    UpdateFolderPresentation, UpdateLayer, UpdateLibraryFolder, UpdateLibraryItem,
