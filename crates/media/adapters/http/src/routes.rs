...
pub fn router(state: ApiState) -> Router {
    Router::new()
        ...
        .route("/api/v2/fixtures", get(fixtures))
        .route("/api/v2/fixtures/{name}", get(fixture))
...
async fn fixtures() -> impl IntoResponse {
...
async fn fixture(Path(name): Path<String>) -> Result<Response, ApiError> {
