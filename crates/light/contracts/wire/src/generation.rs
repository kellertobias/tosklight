...
use crate::v2::patch::{
    ...
    PatchFixtureUpdateRequest, PatchFixturesOutcome, PatchFixturesRequest,
    PatchProfileRevisionProjection, PatchSnapshot,
};
...
const TYPESCRIPT_PATH: &str = "apps/light-desktop/src/api/generated/light-wire.ts";
const SCHEMA_DIRECTORY: &str = "crates/light/contracts/wire/schemas/v2-command-line";
const EVENT_SCHEMA_DIRECTORY: &str = "crates/light/contracts/wire/schemas/v2-events";
const PATCH_SCHEMA_DIRECTORY: &str = "crates/light/contracts/wire/schemas/v2-patch";
const PLAYBACK_SCHEMA_DIRECTORY: &str = "crates/light/contracts/wire/schemas/v2-playback";
...
fn playback_and_show_artifacts() -> Vec<GeneratedArtifact> {
    vec![
        ...
        patch_request_schema::<PatchFixtureUpdateRequest>("patch-fixture-update-request"),
