...
const worldFamilies = {
	...
	stage: ["Browser UI", "Stage", "Visualization runtime"],
...
const supportedCallPaths = new Set([
	...
	"crossSurface.verifyCurrentAndExplicitPageOscAddressing",
	"cue.expect.metadata",
	"cue.expect.absent",
	...
	"desktopBuilder.expectStagePane",
	...
	"encoder.position.tilt.via.api.set",
	"expect.rejects.toThrow",
	"expect.toThrow",
	"expect.not.toBe",
	"expect.not.toBeNull",
	"expect.not.toHaveClass",
	"expect.outputPacket",
	"expect.selection",
	"expect.toBe",
	"expect.toBeLessThan",
	...
	"group.expect.absent",
	"group.expectApiAuthenticationRejected",
	"dynamic.apply",
	"dynamic.create",
	...
	"preset.expectVisibleSelection",
	"preset.expectVisibleSelectionCount",
	"preset.recall",
	"preset.tapEmptyPoolSlot",
	"preset.via.api.recall",
	"preset.via.api.store",
	"preset.via.api.update",
	"preset.via.keypad.delete",
	"preset.via.keypad.recall",
	...
	"stage.assertChangingFrameBudget",
	"stage.beginChangingFrameMeasurement",
	"stage.captureRetainedSceneState",
	"stage.expectCanvasCapture",
	"stage.expectContextRecovery",
	"stage.expectLane",
	"stage.expectNoStructuralRebuildSince",
	"stage.expectQuality",
	"stage.expectRecovered",
	"stage.expectRendererCreatedSince",
	"stage.expectRendererReleasedSince",
	"stage.expectSettledRendererIdle",
	"stage.expectStale",
	"stage.interruptVisualization",
	"stage.prepareSocketRecoveryProof",
	"stage.resumeVisualization",
	"stage.selectFixture",
	"stage.waitForChangingFrame",
	...
	"virtualPlayback.createExclusionZoneWithAttachedShift",
	"virtualPlayback.deleteExclusionZone",
	"virtualPlayback.expect.assignment",
	"virtualPlayback.expect.button",
	"virtualPlayback.expect.cells",
	"virtualPlayback.expect.effectivePage",
	"virtualPlayback.expect.fence",
	"virtualPlayback.expect.logicalCells",
	"virtualPlayback.expect.mountedCellsBelow",
	"virtualPlayback.expect.physicalRuntimeAbsent",
	"virtualPlayback.expect.runtime",
	"virtualPlayback.expect.zones",
	"virtualPlayback.reload",
	"virtualPlayback.setMainPage",
]);
