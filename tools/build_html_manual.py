...
def decorate_inline_html(rendered: str) -> str:
    ...
    def callout(match: re.Match[str]) -> str:
        ...
        return (
            f'<aside class="callout callout-{html.escape(kind)}" data-callout="{html.escape(kind)}">'
