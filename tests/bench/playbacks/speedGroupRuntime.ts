import { HttpSpeedGroupRuntimeTransport } from "../../../apps/light-desktop/src/api/SpeedGroupRuntimeTransport";
import type {
	SpeedGroupAction,
	SpeedGroupActionOutcome,
	SpeedGroupActionRequest,
} from "../../../apps/light-desktop/src/features/speedGroupRuntime/contracts";
import {
	assertAction,
	assertRequestId,
} from "../../../apps/light-desktop/src/features/speedGroupRuntime/projectionValue";
import { SpeedGroupTransportError } from "../../../apps/light-desktop/src/features/speedGroupRuntime/transport";
